...
export default function Hero() {
  return (
    <div className='items-center flex flex-col bg-white py-3 px-10 bg-black text-white p-20 w-full h-full overflow-hidden relative'>
      <div className='font-medium items-center justify-center space-x-3 mt-20  '>
      ...
      <h1 className='lg:text-5xl md:text-3xl sm:text-xl text-xl mt-0 mb-6'>Explore the world’s leading design portfolios</h1>
      ...
      <div className='font-medium justify-center items-center space-x-3 mt-3 mb-20 md:flex flex-cols'>
