...
export default function NavBar() {
  return (
    <nav className='flex justify-between items-center relative bg-white shadow'>
      
      <div className=' pl-5 hidden w-full md:flex md:items-center md:w-auto' id="menu"> 
      <ul
      class="
        pt-4
    ...
    >
      ...
      <div className='pr-6 flex'>
        ...
        <button className='p-2 text-base font-medium text-gray-900 hover:text-gray-700'>Share my work</button> 
      </div>
    </nav>
  )
}
